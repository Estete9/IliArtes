...
# 📖 [Ili Artes - Crafts] <a name="about-project"></a>

**[Ili Artes - Crafts]** This is a capstone project that required me to distribute the layout with HTML, style it, and make it responsive for mobile and desktop with CSS. I also added menu functionality with JavaScript.
...
In a browser visit [Ili Artes](https://iliartes.netlify.app)
...
Feel free to check the [issues page](https://github.com/Estete9/IliArtes/issues).
